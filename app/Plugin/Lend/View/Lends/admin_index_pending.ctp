	...
	<div class="bg-primary row">
		<ul class="list-inline sec-1 navbar-btn">
			...
			?>
				<li>
					<div class="well-sm">
						<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center adm-usr">'.$this->Html->cInt($step_count[$key], false).'</span><span>' .__l($value). '</span>', array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::PendingAction, 'step'=> $key), array('escape' => false));?>
					</div>
				</li>
			<?php
					}
			...
			<table class="table table-striped">
				...
				<tbody class="h6">
					...
					<tr>
						...
						<td>
							<i title="<?php echo !empty($project['Lend']['LendProjectStatus'])?$this->Html->cText($project['Lend']['LendProjectStatus']['name'], false):'Drafted';?>" class="fa fa-square project-status-<?php echo $this->Html->cInt($project['Lend']['lend_project_status_id'], false);?>"></i>
