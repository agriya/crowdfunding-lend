...
<?php
  //for small pie chart
      ...
      $project_percentage .= ($project_percentage != '') ? ',' : '';
      $project_stat .= (!empty($project_stat)) ? '|'.__l('Open for Lending') : __l('Open for Funding');
...
<div class="main-admn-usr-lst js-response">	
	<div class="thumbnail clearfix row navbar-btn no-border">			
		...
		<div class="col-md-3 col-sm-4 col-xs-12 col-lg-offset-0 col-sm-offset-4 img-thumbnail marg-top-30 clearfix">
			...
			<div class="pull-left text-info">	
				<span class="show"><?php echo sprintf(__l('%s Status'), Configure::read('project.alt_name_for_project_singular_caps')); ?></span>		
				<?php
				$total_pie_chart = $goal_reached+$expired_project_count;
				?>			
				<span>
				<?php echo __l('Private Info'); ?> <i title="<?php echo sprintf(__l('This is private info. You can able to set Genuine/Not Genuine for Project Closed %s'), Configure::read('project.alt_name_for_project_plural_caps')); ?>"  data-placement="left" class="js-tooltip fa fa-question-circle"></i>
				</span>
				<div><?php echo __l('Genuine') . ': '.$successful_projects; ?></div>
				<div><?php echo __l('Not Genuine') . ': '.$failed_projects; ?> <i title="<?php echo __l('Project closed, but project owner did fraudulent'); ?>" data-placement="left" class="fa fa-question-circlejs-tooltip"></i></div>
			</div>					
		</div>			
	</div>	
	<div class="row bg-primary">		
		<ul class="list-inline sec-1 navbar-btn">
			...
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center gol-usr">'.$this->Html->cInt($total_flexible_projects,false).'</span><span>' .__l('Flexible'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Flexible), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center adm-usr">'.$this->Html->cInt($total_fixed_projects,false).'</span><span>' .__l('Fixed'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Fixed), array('escape' => false));?>
				</div>
			</li>
			<?php endif; ?>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block act-usr text-center">'.$this->Html->cInt($active_projects,false).'</span><span>' .__l('Active'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Active), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center ina-usr">'.$this->Html->cInt($inactive_projects,false).'</span><span>' .__l('Inactive'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Inactive), array('escape' => false));?>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center ste-usr">'.$this->Html->cInt($featured_projects,false).'</span><span>' .__l('Featured'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Featured), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center twtr-usr">'.$this->Html->cInt($suspended,false).'</span><span>' .__l('Suspended'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Suspend), array('escape' => false, 'title' => __l('Suspended')));?>
				</div>
			</li>
			<?php if(isPluginEnabled('ProjectFlags')): ?>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center lkdn-usr">'.$this->Html->cInt($system_flagged,false).'</span><span>' .__l('System Flagged'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Flagged), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center yho-usr">'.$this->Html->cInt($user_flagged,false).'</span><span>' .__l('User Flagged'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::UserFlagged), array('escape' => false));?>
				</div>
			</li>
			<?php endif; ?>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center fb-usr">'.$this->Html->cInt($system_drafted,false).'</span><span>' .__l('Drafted'). '</span>', array('controller'=>'lends','action'=>'index','filter_id' => ConstMoreAction::Drafted), array('escape' => false));?>
				</div>
			</li>
			<li>
				<div class="well-sm">
					<?php echo $this->Html->link('<span class="img-circle img-thumbnail bg-sucess img-wdt center-block text-center opn-i-usr">'.$this->Html->cInt($total_projects,false).'</span><span>' .__l('All'). '</span>', array('controller'=>'lends','action'=>'index'), array('class' => 'text-center', 'escape' => false));?>
				</div>
			</li>
		</ul>
	</div>	
	<div class="clearfix lends">		
		<h3>
			...
			<?php echo $this->Html->link('<button type="button" class="btn btn-success">'.__l('Add').' &nbsp; <span class="badge"><i class="fa fa-plus"></i></span></button>', array('controller' => 'projects', 'action' => 'add', 'project_type' => 'lend'),array('title' =>  __l('Add'), 'escape' => false));?>
		</h3>
		<ul class="list-unstyled clearfix">
			...
			<li class="pull-right"> 
				<div class="form-group srch-adon">
					  <?php echo $this->Form->create('Project' ,array('url' => array('controller' => 'lends','action' => 'index')),array('type' => 'get', 'class' => 'form-search','action' => 'index')); ?>
			...
			<table class="table table-striped table-bordered" id="js-expand-table">
				<thead class="h5">
					<tr class="js-even">       
						...
						<th colspan="4" class="text-center"><span class="clearfix"><?php echo __l('Analytic Count') ;?></span><i class="fa fa-info-circle js-tooltip" data-placement="left" title="<?php echo __l('Counts showing here were shared the project on Facebook, Twitter, LinkedIn, Google.'); ?>"></i></th>
						<?php endif; ?>
					</tr>
					<tr class="js-even">
				...
				<tbody class="h5">
					...
					<tr class="<?php echo $class .$disabled. $altrow_class;?> cur">
						...
						<i title="<?php echo !empty($project['Lend']['LendProjectStatus'])?$this->Html->cText($project['Lend']['LendProjectStatus']['name'], false):'Drafted';?>" class="fa fa-square project-status-<?php echo $project['Lend']['lend_project_status_id'];?>"></i>
						...
						<div class="progress">
						<div style="width:<?php echo ($collected_percentage > 100) ? '100%' : $collected_percentage.'%'; ?>;" title = "<?php echo $this->Html->cFloat($collected_percentage, false).'%'; ?>" class="progress-bar progress-bar-warning"></div>
						</div>
						...
						<td class="text-center lend"><span class="label btn-warning"><?php echo $this->Html->cCurrency($project['Project']['fee_amount']);?></span></td>
						<td class="text-center lend"><span class="label btn-warning"><?php echo $this->Html->cCurrency($project['Project']['commission_amount']);?></span></td>
						<td class="text-center lend">
						<?php
						...
						<div class="progress">
						<div style="width:<?php echo ($project_progress_precentage > 100) ? '100%' : $project_progress_precentage.'%'; ?>;" title = "<?php echo $this->Html->cFloat($project_progress_precentage, false).'%'; ?>" class="progress-bar progress-bar-warning"></div>
						</div>
						<?php endif; ?>
							...
							<div class="clearfix row">
								<div class="col-xs-2">
									...
									<ul class="list-unstyled clearfix line-height-25">
										...
										<li><?php echo $this->Html->link('<i class="fa fa-hdd-o fa-fw"></i>'.sprintf(__l('Change status to %s'),Configure::read('project.alt_name_for_lend_singular_small')), array('controller'=>'projects','action'=>'admin_open_funding', $project['Project']['id'], 'type' => 'open'), array('class' => 'js-confirm',  'escape'=>false,'title' =>sprintf(__l('Change status to %s'),Configure::read('project.alt_name_for_lend_singular_small'))));?></li>
										<?php endif; ?>
										...
										?>
										<div>
										<a class="js-approve-link js-no-pjax" data-href="dropdown-<?php echo $i; ?>" data-target="#js-ajax" data-toggle="modal" title="<?php echo $label_approve;?>" href="<?php echo $redirect_url; ?>"><i class="fa fa-cog fa-fw"></i><?php echo $label_approve; ?></a>
										<div class="dropdown-menu js-pending-list clearfix js-approve" id="dropdown-<?php echo $i; ?>">
										<div class="text-center"><?php echo $this->Html->image('ajax-follow-loader.gif', array('class'=>'js-loader', 'alt'=>'Loader')); ?></div></div></div>
										</li>
										...
										<?php else: ?>
										<?php if($project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::OpenForLending || $project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::Pending || $project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::ProjectCanceled || $project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::OpenForIdea):?>
										...
										<li><?php echo $this->Html->link('<i class="fa fa-times-circle-o  fa-fw"></i>'.__l('Clear User Flag'), array('controller'=>'projects','action' => 'admin_update_status', $project['Project']['id'], 'status' => 'userflag-deactivate', 'project_type' => $project['ProjectType']['slug']), array('class' => 'js-confirm','escape'=>false, 'title' => __l('Clear User Flag')));?></li>
										<?php endif;?>
										<?php if($project['Project']['is_admin_suspended']):?>
										<li> <?php echo $this->Html->link('<i class="fa fa-repeat  fa-fw"></i>'.__l('Unsuspend'), array('controller'=>'projects','action' => 'admin_update_status', $project['Project']['id'], 'status' => 'unsuspend', 'project_type' => $project['ProjectType']['slug']), array('class' => 'js-confirm','escape'=>false, 'title' => __l('Unsuspend')));?></li>
										<?php else: ?>
										<?php if($project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::OpenForLending || $project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::Pending || $project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::ProjectCanceled || $project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::OpenForIdea):?>
										...
										<?php endif;?>
										<?php endif; ?>
										<?php if($project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::OpenForLending || $project['Lend']['lend_project_status_id'] == ConstLendProjectStatus::Pending):?>
								...
								<div class="col-xs-3">
									...
									<dl class="clearfix project-action">
										...
										<dt class="col-xs-7"><?php echo Configure::read('project.alt_name_for_lender_plural_caps'); ?></dt>
								...
								<div class="col-xs-3">
									<dl class="clearfix h4">
										<?php if (!empty($project['Lend']['project_fund_goal_reached_date'])) : ?>
										<dt class="text-left col-xs-7 no-pad text-warning"><?php echo __l('Lending Goal Reached Date'); ?></dt>
										<dd class="col-xs-5"><?php echo $this->Html->cDateTimeHighlight($project['Lend']['project_fund_goal_reached_date']); ?></dd>
										<?php endif; ?>
										<dt class="text-left col-xs-7 no-pad text-warning"><?php echo __l('Posted On'); ?></dt>
										<dd class="col-xs-5"><?php echo $this->Html->cDateTimeHighlight($project['Project']['created']); ?></dd>
										<dt class="text-left col-xs-7 no-pad text-warning"><?php echo __l('Listing Fee Paid'); ?></dt>
										<dd class="col-xs-5"><?php echo $this->Html->cBool($project['Project']['is_paid']); ?></dd>
									</dl>
								</div>
							</div>
						</td>
					...
					?>
					<tr class="js-even">
						<td colspan="22" class="text-center text-danger"><i class="fa fa-exclamation-triangle fa-fw"></i> <?php echo sprintf(__l('No %s available'), Configure::read('project.alt_name_for_lend_singular_caps') . ' ' . Configure::read('project.alt_name_for_project_plural_caps'));?></td>
					</tr>
					<?php
					endif;
					?>
