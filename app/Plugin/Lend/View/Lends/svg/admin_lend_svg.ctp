 ...
 <?php echo'<sodipodi:namedview
  ...
  echo'<g
    ...
    echo'<g
     ...
     id="g9211">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'projects','action'=>'add','project_type'=> "lend"),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<g
     ...
     id="g9139">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::Pending),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<g
     ...
     id="g9216">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::OpenForLending),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<text
       ...
       x="486.0293"
       y="246.46765"
       style="font-size:12px;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;fill:#ffffff;fill-opacity:1;font-family:Arial;-inkscape-font-specification:Arial">'.__l('Open for lending') . ' (' . $this->Html->cInt($opened_project_count,false) . ')'.'</tspan>'; echo'</text>';
    echo '</a>';
    echo'</g>';
    echo'<path
     inkscape:connector-curvature="3"
    ...
    echo'<g
     ...
     id="g9221">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::ProjectAmountRepayment),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<text
       ...
       x="681.52637"
       y="246.47058"
       style="font-size:12px;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;fill:#ffffff;fill-opacity:1;font-family:Arial;-inkscape-font-specification:Arial">'.sprintf(__l('Amount Repayment (%s)'),$this->Html->cInt($goal_reached,false)).'</tspan>'; echo'</text>';
    echo '</a>';
    echo'</g>';
    echo'<g
     transform="translate(0,640)"
     id="g9226">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::ProjectClosed),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<path
     ...
     inkscape:connector-type="polyline"
     id="path8348"
     d="m 817.5,883.36218 22.5,0"
     style="fill:none;stroke:#000000;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1;marker-end:url(#Arrow2Mend-4)" />';
    echo'<g
     transform="translate(26,664)"
     id="g9105">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','transaction_type_id' => ConstTransactionTypes::ListingFee),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
   ...
   echo '</a>';
    ...
    echo'<g
     ...
     id="g9105-2">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::OpenForIdea),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
   ...
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::ProjectCanceled),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<g
     ...
     id="g9238">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::ProjectExpired),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
   ...
   echo'<g
     ...
     id="g9238">';
   echo '<a
     xlink:href="'.Router::url(array('controller'=>'lends','action'=>'index','project_status_id' => ConstLendProjectStatus::PendingAction),true).'"
     target="_top"
     id="a64-6">';
    echo'<rect
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('If listing fee added in settings, all %s can be added only when %s pay the fee.'), Configure::read('project.alt_name_for_project_plural_small'), Configure::read('project.alt_name_for_lend_project_owner__singular_small')).'\',this, 70, 120)"
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''. sprintf(__l('If idea enabled, all projects considered as ideas. If not, considered as %s.'), Configure::read('project.alt_name_for_project_plural_small')).'\',this, 70, 120)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-7">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
	...
	if($formFieldStep){
		echo'<g
		 ...
		 onmousemove="ShowTooltip(evt, \''.sprintf(__l('All %s will be approved by Admin.'), Configure::read('project.alt_name_for_project_plural_small')).'\',this, 70, 120)"
		 onmouseout="HideTooltip(evt, this)"
		 id="g10936-2">';
	} else {
		echo'<g
		 transform="matrix(0.71715729,0,0,0.70227083,260.46661,488.72137)" class="circle first"
		 onmousemove="ShowTooltip(evt, \''.sprintf(__l('All %s will be approved automatically.'), Configure::read('project.alt_name_for_project_plural_small')).'\',this, 70, 120)"
		 onmouseout="HideTooltip(evt, this)"
		 id="g10936-2">';
	}
    echo'<rect
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('If idea is enabled, initially all the %s will be considered as an idea. Based on votes, it will be moved as a %s by administrator.'), Configure::read('project.alt_name_for_project_singular_small'), Configure::read('project.alt_name_for_project_singular_small')).'\',this, 70, 120)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-6">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.__l("Amount authorization will be canceled").'\',this, 70, 120)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-8">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('%s accepting lending from %s.'), Configure::read('project.alt_name_for_project_plural_caps'), Configure::read('project.alt_name_for_backer_plural_small')).'\',this, 70, 120)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-5">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \'' .sprintf(__l('If needed amount not reached within the %s end date, %s moves to expire and preapproved authorization will be canceled.'), Configure::read('project.alt_name_for_project_singular_small'), Configure::read('project.alt_name_for_project_plural_small')) .'\',this, 110, 30)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-0">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
    ...
    echo'<g
     ...
     onmousemove="ShowTooltip(evt, \''.sprintf(__l('All fundings move to %s wallet and commission amount moves to site admin account.'), Configure::read('project.alt_name_for_lend_project_owner_singular_small')).'\',this, 180, 50)"
     onmouseout="HideTooltip(evt, this)"
     id="g10936-3">';
    echo'<rect
       style="fill:#404040;fill-opacity:1;fill-rule:nonzero"
