<?  
    ...
    echo $this->requestAction(array('controller' => 'lends', 'action' => 'fund_index', 'admin' => true, 'type' => $type, 'project_id' => $project_id, 'q' => $q), array('return'));
    }
    else
    {
    echo $this->requestAction(array('controller' => 'lends', 'action' => 'fund_index', 'admin' => true, 'type' => $type, 'q' => $q, 'page'=> 2), array('return'));
    }
?>